[hr]
[center][size=16pt][b]Google Member Map[/b][/size][/center]
[hr]
...
The Google JavaScript Maps API V3 to create the map and place pins.  This API is available for any web site that is free to consumers. By enabling and using this addon you will be acknowledging and agreeing to the [url=https://code.google.com/apis/maps/terms.html] Google terms of use[/url].  You will also need to [url=https://developers.google.com/maps/documentation/javascript/get-api-key] Get an API key[/url] from Google.
